...
export type BookReaderTextResolver = (key: string, params?: TextParams, fallback?: string) => string;

export function useBookReaderText(): {
  locale: SupportedLocale;
  translate: BookReaderTextResolver;
  text: BookReaderTextResolver;
} {
  ...
  const text = useMemo<BookReaderTextResolver>(
