...
export function validateLayoutConfig(config: LayoutConfig): {
  ...
  } else if (config.props.background.mode === "image" && !isSafeBoxAssetPath(config.props.background.assetPath)) {
  ...
  } else if (config.props.topRegion.mode === "image" && !isSafeBoxAssetPath(config.props.topRegion.assetPath)) {
