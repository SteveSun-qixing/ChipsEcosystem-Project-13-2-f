        ...
        <ChipsStack gap="var(--chips-layout-gap-lg, var(--chips-base-space-4))">
          ...
          >
            ...
            <ChipsForm.Field
              ...
              name="columnMode"
            >
              <ChipsForm.Label>{getLayoutMessage(locale, "editor.column_mode")}</ChipsForm.Label>
              <ChipsSegmentedControl
                value={config.props.columnMode}
                ariaLabel={getLayoutMessage(locale, "editor.column_mode")}
                options={[
                  {
                    value: "compact",
                    label: getLayoutMessage(locale, "editor.column_compact"),
                  },
                  {
                    value: "auto",
                    label: getLayoutMessage(locale, "editor.column_auto"),
                  },
                  {
                    value: "wide",
                    label: getLayoutMessage(locale, "editor.column_wide"),
                  },
                ]}
                onValueChange={(value: string) => {
                  commit(updateProps(config, {
                    columnMode: value as ColumnMode,
                  }));
                }}
              />
              <ChipsForm.Hint>
                {getLayoutMessage(locale, "editor.column_mode_hint")}
              </ChipsForm.Hint>
            </ChipsForm.Field>
            ...
            <ChipsForm.Field
              ...
              name="gap"
            >
              <ChipsForm.Label>{getLayoutMessage(locale, "editor.gap")}</ChipsForm.Label>
              <ChipsSegmentedControl
                value={config.props.gap}
                ariaLabel={getLayoutMessage(locale, "editor.gap")}
                options={[
                  {
                    value: "compact",
                    label: getLayoutMessage(locale, "editor.gap_compact"),
                  },
                  {
                    value: "regular",
                    label: getLayoutMessage(locale, "editor.gap_regular"),
                  },
                  {
                    value: "spacious",
                    label: getLayoutMessage(locale, "editor.gap_spacious"),
                  },
                ]}
                onValueChange={(value: string) => {
                  commit(updateProps(config, {
                    gap: value as GapMode,
                  }));
                }}
              />
            </ChipsForm.Field>
            ...
            <ChipsForm.Field
              ...
              name="titleMode"
            >
              <ChipsForm.Label>{getLayoutMessage(locale, "editor.title_mode")}</ChipsForm.Label>
              <StableSelect
                value={config.props.titleMode}
                placeholder={getLayoutMessage(locale, "editor.title_mode")}
                i18n={i18n}
                options={[
                  {
                    value: "below-cover",
                    label: getLayoutMessage(locale, "editor.title_below"),
                  },
                  {
                    value: "overlay",
                    label: getLayoutMessage(locale, "editor.title_overlay"),
                  },
                  {
                    value: "hidden",
                    label: getLayoutMessage(locale, "editor.title_hidden"),
                  },
                ]}
                onValueChange={(value: string) => {
                  commit(updateProps(config, {
                    titleMode: value as TitleMode,
                  }));
                }}
              />
            </ChipsForm.Field>
            ...
            <ChipsForm.Field
              ...
              name="showSummary"
            >
              <ChipsForm.Label>{getLayoutMessage(locale, "editor.entry_text")}</ChipsForm.Label>
              <ChipsCheckbox
            ...
            <ChipsForm.Field
              ...
              name="pageSize"
            >
              <ChipsForm.Label>{getLayoutMessage(locale, "editor.page_size")}</ChipsForm.Label>
              <StableNumberInput
                ...
                step={20}
                largeStep={40}
                ariaLabel={getLayoutMessage(locale, "editor.page_size")}
          ...
          <FrameRegionEditor
            ...
            previewRatio="16:9"
            preferredAssetPrefix="assets/layouts/masonry/background"
          ...
          <FrameRegionEditor
            ...
            previewRatio="16:5"
            preferredAssetPrefix="assets/layouts/masonry/top-region"
            readBoxAsset={readBoxAsset}
            importBoxAsset={importBoxAsset}
            deleteBoxAsset={deleteBoxAsset}
            onChange={(nextRegion) => {
