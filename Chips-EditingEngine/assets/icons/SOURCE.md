# EditingEngine 应用插件图标来源说明

- 正式设计源目录：`design-assets/Appicon/`
- 对应设计源文件：`EditingEngine.png/.ico/.icns/.svg`
- Material Symbols 名称：`edit_note`
- 官方 SVG 缓存：`design-assets/material-symbols/svg/rounded/edit_note.svg`
