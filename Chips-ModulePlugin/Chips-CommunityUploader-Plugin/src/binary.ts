import { createCommunityUploaderError } from "./errors";
...
export const normalizeBinaryPayload = (value: unknown): Uint8Array => {
  ...
  throw createCommunityUploaderError("COMMUNITY_UPLOADER_FILE_READ_FAILED", "Host file.read did not return binary data.");
};
