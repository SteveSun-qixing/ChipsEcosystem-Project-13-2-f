# FileConversion 模块插件图标来源说明

- 正式设计源目录：`design-assets/Moduleicon/`
- 对应设计源文件：`FileConversion.png/.ico/.icns/.svg`
- Material Symbols 名称：`sync_alt`
- 官方 SVG 缓存：`design-assets/material-symbols/svg/rounded/sync_alt.svg`
