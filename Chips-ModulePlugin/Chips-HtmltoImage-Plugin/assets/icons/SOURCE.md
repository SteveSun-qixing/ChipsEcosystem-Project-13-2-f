# HtmltoImage 模块插件图标来源说明

- 正式设计源目录：`design-assets/Moduleicon/`
- 对应设计源文件：`HtmltoImage.png/.ico/.icns/.svg`
- Material Symbols 名称：`image_search`
- 官方 SVG 缓存：`design-assets/material-symbols/svg/rounded/image_search.svg`
