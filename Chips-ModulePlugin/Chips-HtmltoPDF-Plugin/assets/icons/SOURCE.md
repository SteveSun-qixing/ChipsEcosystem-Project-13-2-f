# HtmltoPDF 模块插件图标来源说明

- 正式设计源目录：`design-assets/Moduleicon/`
- 对应设计源文件：`HtmltoPDF.png/.ico/.icns/.svg`
- Material Symbols 名称：`picture_as_pdf`
- 官方 SVG 缓存：`design-assets/material-symbols/svg/rounded/picture_as_pdf.svg`
