...
describe("dark theme preview matrix", () => {
  it("documents dark theme runtime surfaces against real contract scopes", async () => {
    ...
    expect(matrix.themeId).toBe("chips-official.default-dark-theme");
